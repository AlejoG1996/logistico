...
function Login() {
    const { isDark, toggleDarkMode, showPassword, setShowPassword, login, error, setError, isLoading } = React.useContext(LogisticoContext);
                    ...
                    <div id="selectform" className="w-[90%] lg:w-[50%] ml-0 lg:ml-10 h-[450px] lg:h-[100%] bg-[rgba(255,255,255,0.3)] dark:bg-[rgba(47,51,51,0.3)] backdrop-blur-md rounded-md shadow-xl flex justify-center items-center order-2 lg:order-1 ">
                        <div className="w-full justify-center">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mt-6 mx-10">
                                    {error && (
                                        <div className="flex items-center p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-red-100 dark:text-red-700 dark:border-red-600" role="alert">
