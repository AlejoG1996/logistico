...
function SideBarChart() {
    ...
    const { isDark, toggleDarkMode, isOpenSideBar, toggleSidebar, setIsOpenSideBar,logout } = React.useContext(LogisticoContext);
            ...
            <div className={`z-100 h-screen hidden lg:flex flex-col bg-zinc-100 dark:bg-[#101014] pt-4 relative ${isOpenSideBar ? 'w-62 p-4' : 'w-18 p-4'} transition-all duration-300 ease-in-out ring-1 ring-zinc-200 dark:ring-zinc-900`}>
                ...
                <div className="flex flex-col justify-between flex-1 mt-4 z-40">
                    ...
                    <ul className="space-y-2">
                        ...
                        <li onClick={() => {
                            logout(); // Elimina token del context/state
                            navigate('/login');
                        }} className=" h-10 relative flex items-center justify-center rounded-md cursor-pointer hover:text-zinc-600 hover:dark:text-white text-zinc-400 hover:bg-zinc-300 hover:dark:bg-zinc-800 transition-all ease-in-out duration-500 group">
                            <div className="w-10 h-full flex justify-center items-center">
